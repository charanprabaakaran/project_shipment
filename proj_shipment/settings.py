"""
Django settings for proj_shipment project.
...
SECRET_KEY = 'django-insecure-#@@oh3$87gj+0cl+7e9m5hqc^ar)#^jpoz1u38!su&8m+#50+$'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["54.170.34.7","ec2-54-170-34-7.eu-west-1.compute.amazonaws.com"]
DEBUG = False
...
# AUTH_USER_MODEL = 'app_shipment.user_table'
...
ROOT_URLCONF = 'proj_shipment.urls'
...
WSGI_APPLICATION = 'proj_shipment.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, "app_shipment/static")]
...
AWS_STORAGE_BUCKET_NAME = "x23379162"
AWS_S3_REGION_NAME = "eu-west-1"
AWS_S3_CUSTOM_DOMAIN = f"x23379162.s3.eu-west-1.amazonaws.com"
